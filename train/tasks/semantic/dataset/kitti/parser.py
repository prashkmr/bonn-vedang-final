...
class Parser():
  ...
  def __init__(self,
    ...
    # print("valid_sequences: ", self.valid_sequences)
    # print("labels: ", self.labels)
    # print("color_map: ", self.color_map)
    # print("learning_map: ", self.learning_map)
    # print("learning_map_inv: ", self.learning_map_inv)
    # print("sensor: ", self.sensor)
    # print("max_points: ", self.max_points)
    # print("batch_size: ", self.batch_size)
    # print("workers: ", self.workers)
    # print("gt: ", self.gt)
    # print("shuffle_train: ", self.shuffle_train)
    ...
    self.valid_dataset = SemanticKitti(root=self.root,
                                       ...
                                       max_points=max_points,
                                       gt=self.gt)
    # print("valid_dataset: ", self.valid_dataset, " len: ", len(self.valid_dataset))
    self.validloader = torch.utils.data.DataLoader(self.valid_dataset,
                                                  #  batch_size=self.batch_size,
                                                   ...
                                                   pin_memory=True,
                                                   drop_last=True)
    # print("validloader: ", self.validloader, " len: ", len(self.validloader))                                                   
